"""
Django settings for MySocailMedia project.
...
SECRET_KEY = 'django-insecure-f#^-d%i)rn&ugv6lak06j$tv28wz-%31ea8k!&!i63@oz&_x2p'
...
ROOT_URLCONF = 'MySocailMedia.urls'
...
WSGI_APPLICATION = 'MySocailMedia.wsgi.application'
...
# we need to tell djanogo use ouer user not yours
